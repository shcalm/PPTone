...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --enable-neon --enable-asm --arch=arm --enable-cross-compile
prefix=/usr/local
...
SRC_PATH="/media/source/st-ericsson_release_client/external/ffmpeg-0.8.2"
SRC_PATH_BARE=/media/source/st-ericsson_release_client/external/ffmpeg-0.8.2
CC_IDENT=gcc 4.4.5 (Ubuntu/Linaro 4.4.4-14ubuntu5)
ARCH=arm
CC=gcc
AS=gcc
LD=gcc
...
VCODEC_TESTS=asv1 asv2 dnxhd_1080i dnxhd_720p dnxhd_720p_rd dv dv50 error ffv1 flashsv flashsv2 flv h261 h263 h263p huffyuv jpegls ljpeg mjpeg mpeg mpeg1b mpeg2 mpeg2thread mpeg4 mpeg4adv mpeg4nr mpeg4thread msmpeg4 msmpeg4v2 msvideo1 qtrle qtrlegray rc rgb roq rv10 rv20 snow snowll svq1 vref wmv1 wmv2 yuv 
LAVF_TESTS=aiff alaw asf au avi bmp dv_fmt ffm flv_fmt gif gxf jpg mkv mmf mov mpg mulaw mxf nut ogg pbmpipe pcx pgm pgmpipe pixfmt png ppm ppmpipe rm sgi swf tga tiff ts voc voc_s16 wav yuv4mpeg 
