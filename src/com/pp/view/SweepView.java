...
//    private SweepView mValidAfterDynamic;
//    private SweepView mValidBeforeDynamic;
//
...
//        public void onSweep(SweepView sweep, boolean sweepDone);
//        public void requestEdit(SweepView sweep);
//    }
//
...
//
//    private SweepView[] mNeighbors = new SweepView[0];
//
...
//        setBackgroundResource(R.drawable.sweep_background);
//
...
//    }
//
//    public void setNeighbors(SweepView... neighbors) {
...
//     * ranges is used.
//     */
//    public void setValidRangeDynamic(SweepView validAfter, SweepView validBefore) {
...
//     */
//    public boolean isTouchCloserTo(MotionEvent eventInParent, SweepView another) {
...
//                for (SweepView neighbor : mNeighbors) {
...
//    }
//
//    public static float getLabelTop(SweepView view) {
//        return view.getY() + view.mContentOffset.top;
//    }
//
//    public static float getLabelBottom(SweepView view) {
//        return getLabelTop(view) + view.mLabelLayout.getHeight();
//    }
//
//    public static float getLabelWidth(SweepView view) {
